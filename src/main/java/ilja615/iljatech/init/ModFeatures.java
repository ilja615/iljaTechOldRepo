...
public class ModFeatures
{
    ...
    public static void registerFeatures()
    {
        ...
        RUBY_GEODE_PF = Registry.register(BuiltinRegistries.PLACED_FEATURE, new ResourceLocation(IljaTech.MOD_ID, "ruby_geode_pf"), RUBY_GEODE_CF.placed(RarityFilter.onAverageOnceEvery(24), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.aboveBottom(6), VerticalAnchor.absolute(30)), BiomeFilter.biome()));
    }
