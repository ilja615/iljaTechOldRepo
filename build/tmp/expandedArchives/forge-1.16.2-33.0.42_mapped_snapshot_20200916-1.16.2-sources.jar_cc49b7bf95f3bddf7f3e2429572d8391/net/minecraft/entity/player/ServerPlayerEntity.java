...
public class ServerPlayerEntity extends PlayerEntity implements IContainerListener {
   ...
   public Entity changeDimension(ServerWorld server, net.minecraftforge.common.util.ITeleporter teleporter) {
      ...
      if (registrykey == World.THE_END && server.getDimensionKey() == World.OVERWORLD && teleporter instanceof net.minecraft.world.Teleporter) { //Forge: Fix non-vanilla teleporters triggering end credits
         this.detach();
