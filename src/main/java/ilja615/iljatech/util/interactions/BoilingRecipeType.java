...
public class BoilingRecipeType implements Recipe<Container>
{
...
public BoilingRecipeType(RecipeType<?> p_44416_, RecipeSerializer<?> p_44417_, ResourceLocation p_44418_, Ingredient p_44420_, ItemStack p_44421_) {
        this.type = p_44416_;
