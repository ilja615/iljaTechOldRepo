...
public class CrushingRecipe implements Recipe<Container>
{
    ...
    public CrushingRecipe(RecipeSerializer<?> p_44417_, ResourceLocation p_44418_, Ingredient p_44420_, ItemStack p_44421_) {
    ...
    {
        public CrushingRecipe fromJson(@Nonnull ResourceLocation recipeId, @Nonnull JsonObject pSerializedRecipe)
        {
            ...
            return new CrushingRecipe(ModRecipeSerializers.CRUSHING.get(), recipeId, ingredient, itemstack);
        }
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buffer, CrushingRecipe recipeType)
        {
